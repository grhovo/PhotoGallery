...
public class PollService extends IntentService {
    ...
    public static final String PERM_PRIVATE = "com.android.hovo.photogallery.PRIVATE";
    public static final String ACTION_SHOW_NOTIFICATION = "com.android.hovo.photogallery.SHOW_NOTIFICATION";
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        String lastResult = QueryPreferences.getLastResult(this);
